...
```
Changelog:
- June 26, 2025. Added new Analytics chart for Service Type (Tipo de Atendimento) - displays service type descriptions abbreviated to 4 characters, follows same visual pattern as other charts
